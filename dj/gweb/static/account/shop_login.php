...
<style>
.sDt_innercontent{background: #fff; position: relative;}
.sDt_innercontent fieldset{width: auto; padding: 20px 0 0 0;}
.sDt_c-f-text{ height: 40px; }
.sDt_innercontent .sDt_username .sDt_st::before{background-position: 7px 15px; height: 40px;}
.sDt_innercontent .sDt_pwd .sDt_st::before { background-position: 10px -41px; height: 32px;}
.sDt_innercontent .sDt_field{margin:15px auto 0; width: 280px; }
.sDt_c-btn-orange{
    cursor: pointer;
    ...
    background: gradient(linear, center top, center bottom, from(#34b2ed), to(#019be3)); 
   background: -webkit-gradient(linear, center top, center bottom, from(#34b2ed), to(#019be3)); 
    background:-moz-gradient(linear, center top, center bottom, from(#34b2ed), to(#019be3)); 
    background:-o-gradient(linear, center top, center bottom, from(#34b2ed), to(#019be3));
}
.btn_maw{width: 280px; margin: 0 auto; min-height: 52px; position: relative;}
.btn_matic{height:30px; float: left; color:#b2b5b5; position: relative; min-width: 132px;}
.btn_matic label:before{content: '';width: 17px; height: 22px; background:url(../static/img/blue.png) no-repeat; background-position:-17px 2px; display: block; float: left; margin-right: 3px; margin-top: 6px;}
.btn_matic label{position: absolute; left: 0; top: 0; height:30px; line-height: 30px;}
.btn_matic input[type="checkbox"] { visibility:hidden;} 
.btn_matic input[type=checkbox]:checked + label:before {  
    background:url(../static/img/blue.png) no-repeat;
    background-position:-34px 2px; 
}  
.btn_forget{float: right; margin-top: 10px !important; padding: 0 !important; width: auto !important; position: relative; margin-top: 0 !important; height: 30px; line-height: 30px;}
.btn_forget a{color:#4587f5;}
.btn_or{background: #fff; width: 30px; height: 30px; border-radius: 30px; position: absolute; left: 50%; bottom: -15px; margin-left: -15px; color: #999; line-height: 30px; text-align: center; font-size: 14px;}
.btn_cont{width: 100%; background: #edeef0; height: 80px; padding-top: 25px;}
.btn_login{overflow: hidden; clear: both; margin-top:15px; 
    ...
    text-align: center; height: 40px; line-height: 40px; width: 280px; margin:0 auto;}
.btn_login a{ color: #fff; font-size: 16px; display: block;}
...
<section class="sDt_innercontent">
                <fieldset>
				<form action="/account/shop_login.php?m=mobile" method="post" id="user_form">
                    <div class="sDt_field sDt_username sDt_err">
                        <div class="sDt_c-form-search sDt_st">
                            <input type="telephone" id="cacct" placeholder="账户名/EMAIL/手机" name="email" value="" class="sDt_c-f-text" />
                        </div>
                    </div>
                    ...
                    <div class="sDt_field sDt_submit-btn">
                      ...
                      <input type="submit" class="sDt_c-btn-orange"  value="登 录"/>
                     
                    </div>
                    <div class="btn_maw">
                        <div class="SdT_field SdT_autologin btn_matic">
                            <input type="checkbox" checked="" class="SdT_f-check" id="autologin" name="auto_login" value="1">
                            <label for="autologin">下次自动登录</label>
                        </div>
    					<div class="sDt_field sDt_submit-btn btn_forget">
                            <a href='getpass.php'>忘记密码？</a>
                        </div>
                        <div class="btn_or">or</div>
                    </div>
                    <div class="btn_cont">
                        <div class="btn_login">
                            <a href='shop_signup.php'>免费注册</a>
                        </div>
                    </div>
					</form>
                </fieldset>
